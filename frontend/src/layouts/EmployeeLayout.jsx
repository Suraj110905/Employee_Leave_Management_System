      ...
      <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 bg-slate-900 text-slate-100 border-r border-slate-800 z-30">
        <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-800">
          ...
          <div>
            ...
            <span className="text-[10px] text-emerald-400 font-semibold tracking-wider uppercase">Employee</span>
          </div>
        </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden md:block text-left">
                ...
                <span className="text-[10px] text-slate-400 font-medium">Software Engineer</span>
              </div>
            </div>
          </div>
        </header>
